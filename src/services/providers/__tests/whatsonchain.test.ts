...
describe('whatsonchain tests', () => {
    ...
    const wocTest = new WhatsOnChain(envTest.chain, { apiKey: envTest.taalApiKey })
    const envMain = _tu.getEnv('main')
    const wocMain = new WhatsOnChain(envMain.chain, { apiKey: envMain.taalApiKey })
